...
def preprocessing(docs): 
    ...
    for doc in docs:
        sentences = re.split(r"[!.?;]", doc)# split sentence by  . ? 
...
def create_gows(len_train_y,docs, vocab, window_size, directed, to_normalize, use_master_node):
    adj = list()
    features = list()
    subgraphs = list()
    #docs is a 3d list of strings ; doc is 2d
    c = 0
    ...
    return adj, features, subgraphs, num_train_sents
